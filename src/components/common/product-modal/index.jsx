...
import DetailsThumbWrapper from "@/components/shop-banner/product-details/details-thumb-wrapper";
import DetailsWrapper from "@/components/shop-banner/product-details/details-wrapper";
        ...
        <div className="tp-product-modal">
          <div className="tp-product-modal-content d-lg-flex">
            ...
            <DetailsThumbWrapper
              ...
              imageURLs={productItem.product_image}
              imgWidth={100}
              imgHeight={150}
              loading={loading}
              status={status}
