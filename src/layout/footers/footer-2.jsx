                  ...
                  <div className="tp-footer-widget footer-col-4-1 mb-50">
                    ...
                    <div className="tp-footer-widget-content">
                      <div className="tp-footer-talk mb-20">
                        ...
                        <h4><Link href="tel:670-413-90-762">+01622064136</Link></h4>
                      </div>
                      <div className="tp-footer-contact">
                        <div className="tp-footer-contact-item d-flex align-items-start">
                          ...
                          <div className="tp-footer-contact-content">
                            <p><Link href="mailto:shofy@support.com">shuvoprogramer@gmail.com</Link></p>
                          </div>
                        </div>
                        <div className="tp-footer-contact-item d-flex align-items-start">
                          <div className="tp-footer-contact-icon">
                          ...
                          <div className="tp-footer-contact-content">
                            <p><Link href="https://www.google.com/maps/place/Sleepy+Hollow+Rd,+Gouverneur,+NY+13642,+USA/@44.3304966,-75.4552367,17z/data=!3m1!4b1!4m6!3m5!1s0x4cccddac8972c5eb:0x56286024afff537a!8m2!3d44.3304928!4d-75.453048!16s%2Fg%2F1tdsjdj4" target="_blank">Savar <br /> Dhaka, Bangladesh</Link></p>
                          </div>
                        </div>
                      </div>
                    </div>
