                            ...
                            <div className="row">
                                        ...
                                        <nav>
                                            <div className="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                                <button className="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                                    <img src={IMG_URL + "/products/" + product.img} alt />
                                                </button>
                                                {product.product_multiple_image?.split(',').map((img, index) => (
                                                    <button
                                                        key={index}
                                                        className="nav-link"
                                                        id={`nav-${index + 2}-tab`}
                                                        data-bs-toggle="tab"
                                                        data-bs-target={`#nav-${index + 2}`}
                                                        type="button"
                                                        role="tab"
                                                        aria-controls={`nav-${index + 2}`}
                                                        aria-selected="false"
                                                    >
                                                        <img src={IMG_URL + "/products/" + img.trim()} alt={`Product ${index}`} />
                                                    </button>
                                                ))}
                                        ...
                                        <div className="tab-content m-img" id="productDetailsNavContent">
                                            ...
                                            {product.product_multiple_image?.split(',').map((img, index) => (
                                                <div
                                                    ...
                                                    id={`nav-${index + 2}`}
                                                    role="tabpanel"
                                                    aria-labelledby={`nav-${index + 2}-tab`}
                                                    tabIndex={0}
                                                >
                                                    <div className="tp-product-details-nav-main-thumb">
                                                        <img src={IMG_URL + "/products/" + img.trim()} alt={`Product ${index}`} />
                                ...
                                <div className="col-xl-5 col-lg-6">
                                    <div className="tp-product-details-wrapper">
                                        ...
                                        <h3 className="tp-product-details-title">{product.product_english_name}/{product.product_marathi_name}</h3>
                                        {/* inventory details */}
                                            ...
                                            <div className="tp-product-details-variation-item">
                                                ...
                                                <div className="tp-product-details-variation-list">
                                                    <button type="button" className="color tp-color-variation-btn">
                                                        <span data-bg-color="#F8B655" style={{ backgroundColor: 'rgb(248, 182, 85)' }} />
                                                        <span className="tp-color-variation-tootltip">Yellow</span>
                                                    </button>
                                                    <button type="button" className="color tp-color-variation-btn active">
                                                        <span data-bg-color="#CBCBCB" style={{ backgroundColor: 'rgb(203, 203, 203)' }} />
                                                        <span className="tp-color-variation-tootltip">Gray</span>
                                                    </button>
                                                    <button type="button" className="color tp-color-variation-btn">
                                                        <span data-bg-color="#494E52" style={{ backgroundColor: 'rgb(73, 78, 82)' }} />
                                                        <span className="tp-color-variation-tootltip">Black</span>
                                                    </button>
                                                    <button type="button" className="color tp-color-variation-btn">
                                                        <span data-bg-color="#B4505A" style={{ backgroundColor: 'rgb(180, 80, 90)' }} />
